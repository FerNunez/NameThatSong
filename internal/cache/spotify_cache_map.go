...
func (c *SpotifyCacheMap) GetTrack(accessToken, trackId string) (spotify_api.TrackData, error) {
	if val, ok := c.TrackMap[trackId]; ok {
		return val, nil
	}
	fmt.Println("[SpotifyCacheMap] GetTrack miss chache trackId:", trackId)
	trackData, err := spotify_api.FetchTrack(accessToken, trackId)
	if err != nil {
...
func (c *SpotifyCacheMap) GetAlbum(accessToken, albumId string) (spotify_api.AlbumData, error) {
	if val, ok := c.AlbumMap[albumId]; ok {
		return val, nil
	}
	fmt.Println("[SpotifyCacheMap] GetAlbum miss chache on AlbumId:", albumId)
	albumData, tracksData, err := spotify_api.FetchAlbum(accessToken, albumId)
	if err != nil {
...
func (c *SpotifyCacheMap) GetArtist(accessToken, artistId string) (spotify_api.ArtistData, error) {
	if val, ok := c.ArtistMap[artistId]; ok {
		return val, nil
	}
	fmt.Println("[SpotifyCacheMap] GetArtist miss chache on ArtistID:", artistId)
	artistData, err := spotify_api.FetchArtist(accessToken, artistId)
	if err != nil {
...
func (c *SpotifyCacheMap) GetPlaylist(accessToken, playlistId string) (spotify_api.PlaylistData, error) {
	if val, ok := c.PlaylistMap[playlistId]; ok {
		return val, nil
	}
	fmt.Println("[SpotifyCacheMap] GetPlaylist miss chache on playlistID:", playlistId)
	playlistData, tracksData, err := spotify_api.FetchPlaylist(accessToken, playlistId)
	if err != nil {
...
func (c *SpotifyCacheMap) GetAlbumsFromArtist(accessToken, artistId string) ([]string, error) {
	...
	albumIDs, err := spotify_api.FetchAlbumsFromArtist(accessToken, artistId)
	if err != nil {
		return []string{}, err
	}
...
func (c *SpotifyCacheMap) GetTracksFromAlbum(accessToken, albumId string) ([]string, error) {
	...
	trackIDs, err := spotify_api.FetchTracksFromAlbum(accessToken, albumId)
	if err != nil {
		return []string{}, err
	}
...
func (c *SpotifyCacheMap) GetTracksFromPlaylist(accessToken, playlistId string) ([]string, error) {
	...
	trackIDs, err := spotify_api.FetchTracksFromPlaylist(accessToken, playlistId)
	if err != nil {
		return []string{}, err
	}

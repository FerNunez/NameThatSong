...
func (h GameHandler) PostRegisterHandler(w http.ResponseWriter, r *http.Request) {
	username := r.FormValue("username")
	password := r.FormValue("password")

	// TODO HERE: CREATE USER + Ask Spotify permission + keys
...
func (h GameHandler) PostLoginHandler(w http.ResponseWriter, r *http.Request) {

...
// SpotifyMusicServiceClient implements the MusicServiceClient interface for Spotify
type SpotifyMusicServiceClient struct {
	AccessToken  string
	RefreshToken string
	ClientID     string
	ClientSecret string
...
// NewSpotifyMusicServiceClient creates a new SpotifyMusicServiceClient
func NewSpotifyMusicServiceClient(accessToken, refreshToken, clientID, clientSecret, deviceID string) *SpotifyMusicServiceClient {
	return &SpotifyMusicServiceClient{
...
func (c *SpotifyMusicServiceClient) PlaySong(songID string) error {
...
func (c *SpotifyMusicServiceClient) PausePlayback() error {
...
func (c *SpotifyMusicServiceClient) ResumePlayback() error {
	url := "https://api.spotify.com/v1/me/player/play"
	if c.DeviceID != "" {
		url = fmt.Sprintf("%s?device_id=%s", url, c.DeviceID)
	}
...
func (c *SpotifyMusicServiceClient) SkipToNext() error {
